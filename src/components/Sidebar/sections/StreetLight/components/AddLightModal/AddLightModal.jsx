...
import styles from "./AddLightModal.module.css";
...
const AddLightModal = ({ onClose, onAdd }) => {
    ...
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div className={styles.modalHeader}>
          <div className={styles.modalIcon}><i className= "fa-solid fa-lightbulb" style={{ color: "white" }}></i></div>
          <div>
            <p className={styles.modalSub}>
              Küçə işığı problemi haqqında məlumat daxil edin
            </p>
          </div>
        ...
        <div className={styles.form}>
          <div className={styles.field}>
            ...
            <input
              ...
              placeholder="Məs: Nizami küçəsi — dirək 14 sönüb"
              value={form.title}
