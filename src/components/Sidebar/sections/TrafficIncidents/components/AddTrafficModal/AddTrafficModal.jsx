...
import styles from "./AddTrafficModal.module.css";
...
const AddTrafficModal = ({ onClose, onAdd }) => {
      ...
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div className={styles.modalHeader}>
          <div className={styles.modalIcon}>
            <i className="fa-solid fa-car-burst" style={{ color: "white" }}></i>
          </div>
          <div>
            <p className={styles.modalSub}>
              Yol-nəqliyyat hadisəsi haqqında məlumat daxil edin
            </p>
          </div>
...
export default AddTrafficModal;
